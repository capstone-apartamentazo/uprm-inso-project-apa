...
const Notice: React.FC<Props> = ({ accmId }) => {
	...
	return (
		<div>
			<div className=''>
				<label htmlFor='noticeModal' className='btn bg-primary text-white hover:bg-secondary'>
			...
			<div className='modal '>
				<div className='modal-box relative flex'>
					...
					<form onSubmit={handleSubmit} className='flex-col  flex-auto '>
						<label htmlFor='noticeModal' className='btn btn-sm btn-circle absolute right-2 top-2'>
							✕
						</label>
