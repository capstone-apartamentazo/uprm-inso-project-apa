...
const ProfileAccommodation: React.FC<Props> = ({ title, address, id }) => {
    ...
    const deleteAccommodation = async (event: any) => {
        ...
        axios.delete(`${host}/api/accommodations/${id}`, config)
            .then(res => {
                alert(res.data)
                mutate(`${host}/api/accommodations/landlord/${storage.id}`)
            })
            .catch(err => {
                console.error(err)
            })
        ...
        <div className='flex justify-center w-72 '>
            ...
            <div className='block max-w-full rounded-lg bg-white shadow-lg ring-1 ring-stone-200 dark:bg-neutral-700 '>
                ...
                <div className='p-4 flex menu-vertical h-36 align-middle'>
                    ...
                    <div className='text-left text-base text-neutral-600 dark:text-neutral-200 flex align-middle gap-1 items-center truncate'>
                        <span>
                    ...
                    <div className='flex items-center gap-2 mx-2 mt-2'>
                        ...
                        }} className='btn  text-white bg-accent hover:bg-accent-focus grow'>Units</Link>
                        ...
                        <div className="tooltip tooltip-error " data-tip="Double click to delete">
                            ...
                            <button onDoubleClick={deleteAccommodation} className='btn bg-error hover:bg-red-800   grow '>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className="w-6 h-6 stroke-white">
