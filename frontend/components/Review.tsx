    ...
    return (
        <div className='flex flex-row ring-1 shadow-lg ring-stone-200 rounded-md mt-4 mb-2'>
            <div className='flex flex-col flex-auto '>
                <h1 className='pt-6 pl-6 pr-6 pb-2 text-2xl font-bold text-left'><a href='/' className='hover:underline'>2BR Condo ON THE BEACH! Restaurant- Pool- Hot Tub!</a></h1>
                ...
                <div className="flex flex-nowrap flex-row  items-center pl-2 pb-2">
                    ...
                    <div className='flex flex-col'>
                        <h1 className='font-semibold'><a href='/' className='hover:underline'>Maya Williams</a></h1>
            ...
            <div className=' m-auto  items-center'>
                <div className=" w-60 p-6 ">
                    <a href='/'><img className='aspect-video rounded-lg hover:shadow-lg hover:ring-1 hover:ring-stone-200' src="https://tecdn.b-cdn.net/img/new/standard/nature/186.jpg" /></a>
                </div>
            </div>
        </div>
    )
